...
def initiate_container(url, id, script_name, iteration_count,  container_timeout):	
    ...
    try:
        ...
        print (f"[{get_time()}] Container with ID {id} created and started sucessfully")
...
def execute_script(url, id, script_name,  iteration_count, container_timeout):
    try:	
        ...
        print (f"[{get_time()}] Container with ID {id} executing script")
        ...
        print (f"[{get_time()}] Container with ID {id} sleeping for {container_timeout}")
        time.sleep(container_timeout)        
        print (f"[{get_time()}] Container with ID {id} adding logs to log ")
        print (logs) 
        for log in logs:
